...
insert into evento (id, nome, descrizione, data, ora_inizio, ora_fine, numero_max_partecipanti, stato, costo_partecipazione) values (1, 'Serata nuovi giocatori', 'Evento introduttivo con giochi semplici e spiegazione delle regole.', current_date, time '20:30:00', time '23:30:00', 12, 'APERTO', 5.00);
insert into evento (id, nome, descrizione, data, ora_inizio, ora_fine, numero_max_partecipanti, stato, costo_partecipazione) values (2, 'Torneo strategia', 'Serata dedicata ai giochi strategici piu lunghi.', current_date + 1, time '19:00:00', time '23:45:00', 8, 'APERTO', 10.00);
insert into evento (id, nome, descrizione, data, ora_inizio, ora_fine, numero_max_partecipanti, stato, costo_partecipazione) values (3, 'Party game night', 'Giochi veloci per gruppi numerosi.', current_date + 7, time '21:00:00', time '23:30:00', 20, 'APERTO', 0.00);
insert into evento (id, nome, descrizione, data, ora_inizio, ora_fine, numero_max_partecipanti, stato, costo_partecipazione) values (4, 'Evento passato completato', 'Evento usato per testare gli stati non aperti.', current_date - 1, time '20:00:00', time '22:30:00', 10, 'COMPLETATO', 3.00);
insert into evento (id, nome, descrizione, data, ora_inizio, ora_fine, numero_max_partecipanti, stato, costo_partecipazione) values (5, 'Evento annullato', 'Evento usato per testare lo stato annullato.', current_date + 14, time '20:00:00', time '22:00:00', 10, 'ANNULLATO', null);
...
insert into iscrizione_evento (id, data_iscrizione, note, utente_id, evento_id) values (1, current_timestamp - interval '3 days', 'Prima iscrizione test.', 2, 1);
insert into iscrizione_evento (id, data_iscrizione, note, utente_id, evento_id) values (2, current_timestamp - interval '2 days', 'Vorrei provare Dixit.', 3, 1);
insert into iscrizione_evento (id, data_iscrizione, note, utente_id, evento_id) values (3, current_timestamp - interval '1 day', 'Posto per il torneo strategia.', 2, 2);

insert into prenotazione (id, data, ora_inizio, ora_fine, numero_persone, note, utente_id, tavolo_id) values (1, current_date, time '19:30:00', time '20:30:00', 4, 'Prenotazione prima della serata introduttiva.', 2, 1);
insert into prenotazione (id, data, ora_inizio, ora_fine, numero_persone, note, utente_id, tavolo_id) values (2, current_date + 1, time '18:30:00', time '19:30:00', 6, 'Gruppo per il torneo.', 3, 2);
